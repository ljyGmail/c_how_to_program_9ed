...
enum RoundStatus
{
    ...
    WON,
    LOST
}; // constants representing round status
...
enum Shape
{
    ...
    PAPER,
    SCISSORS
}; // constants representing possible shapes

enum Shape computerPlayRandomShape(void); // computerPlayRandomShape function prototype
...
int main(void)
{
    ...
    while (CONTINUE == gameStatus) // should keep playing
    {
        ...
        case WON:
            ...
            {
                // Increment win count, if win count reaches threshold, player wins the game
                gameStatus = GAME_WON;
            }
            break;
        case LOST:
            ...
            {
                // Increment win count, if win count reaches threshold, computer wins the game
